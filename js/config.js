...
const SITE_CONFIG = {
  // --- Identity ---
  agentName: "Agent Name",                 // e.g. "K. Venkat Rao"
  designation: "LIC Development Officer",
  agencySince: 2000,
  developmentOfficerSince: 2018,
  teamSize: 30,
  city: "Hyderabad",
  branchDetails: "LIC Branch Office, [Branch Name & Code]",
  licenseNumber: "[Agency / DO Code]",     // shown in footer for compliance

  // --- Contact ---
  phone: "+91 00000 00000",
  whatsappNumber: "910000000000",          // digits only, with country code, no +
  email: "agent@example.com",
  officeAddress: "Office address line 1, Area, City – PIN",
